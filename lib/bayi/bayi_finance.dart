...
import 'package:ornek/bayi/bayi_finance_add.dart';
...
// BayiFinance : finans işlemlerinin listelendiği sayfa

class BayiFinance extends StatefulWidget {
  final int userId;
  const BayiFinance({super.key, required this.userId});

  @override
  State<BayiFinance> createState() => _BayiFinanceState();
}

class _BayiFinanceState extends State<BayiFinance> {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => BayiFinanceAdd(userId: widget.userId),
            ),
          );
          fetchFinanceList();
        },
