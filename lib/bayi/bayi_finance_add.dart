...
// BayiFinanceAdd : Finans işlemlerinin oluşturulduğu sayfa
class BayiFinanceAdd extends StatefulWidget {
  final int userId;
  const BayiFinanceAdd({super.key, required this.userId});

  @override
  State<BayiFinanceAdd> createState() => _BayiFinanceAddState();
}

class _BayiFinanceAddState extends State<BayiFinanceAdd> {
  // Controller
